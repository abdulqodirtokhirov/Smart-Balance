...
# --- 🟢 RENDER УЧУН КИЧИК ВЕБ-СЕРВЕР (УХЛАБ ҚОЛМАСЛИК ҚИСМИ) ---
app = Flask('')
...
if __name__ == "__main__":
    init_db()
    # 🟢 Веб-серверни алоҳида оқимда бошлаймиз (Render учун)
    keep_alive()
    print("Бот ва Веб-сервер ишга тушди...")
    
    # Ботни поллинг режимида юргизиш
